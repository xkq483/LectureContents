public class TrickTest {
    public static void main(String[] args) {
        ...
        // 어?? 이미 맨 앞의 케이스가 참인데 뒤에거 볼 필요가 있어?? 어짜피 참인데???
        // 그래서 뒤의 ++ 코드를 실행하지 않음
...
// 위와 같은 케이스를 어디에서 많이 사용할 수 있을까요 ?
// A : 예제를 통해 알아 봅시다.
//     전체 데이터가 1000개 있다고 가정합니다.
//     케이스 A에 해당하는 데이터는 150개 있습니다.
//     케이스 B에 해당하는 데이터는 600개 있습니다.
//     아무것도 아닌 케이스는 250개 입니다
//     여기서 우리가 찾아야 하는 것은 케이스 A와 케이스 B를 동시에 만족해야합니다.
...
// 결론 : 관계 연산자 AND는 if 연산에서 사용할 때
//       전체에서 적용되는 횟수가 가장 적은 녀석이 맨 앞에 배치될 때 가장 큰 효율을 얻을 수 있다.

// 내가 이해한 내용 : AND는 둘다 참이여야 결과가 도출이 되는데 검사할 케이스가 적을수록 더 큰효율이 되기때문?
