public class RelationshipOperrationTest {
    public static void main(String[] args) {
        ...
        // 표기법 --> 엔터 위에 \ 표시가 있다
        //           Shift + \ 표시를 누르면 파이프 기호가 생성된다.
        // 관계 연산자 OR (||)
        // OR 의 특성 --> 양쪽 중 하나라도 참이면 참
        //               양쪽 모두가 거짓인 경우에만 거짓으로 판정
        if((num4 % num1 == 0) || (num4 % num2 == 0)) {
            System.out.printf("%d의 배수 혹은 %d의 배수이다.\n", num4, num1, num2);
        }
        ...
        // if(!(num4 % num1 == 0) || (num4 % num2 == 0)) 했을땐,
        // 21 % 3 == 0 이 맞으나,(!(num4 % num1 == 0) 앞에 (!)가 들어가 있고 '긍정의 부정은 부정' 에 해당
        // 따라서 둘다 거짓으로 판명되어 else에 있는  출력문을 출력

        // if(!(num4 % num1 == 0) || !(num4 % num2 == 0)) 했을땐.
        // (!(num4 % num1 == 0) -> 거짓, !(num4 % num2 == 0) '부정의 부정은 긍정' 따라서 둘중 하나라도 참인것에 해당
