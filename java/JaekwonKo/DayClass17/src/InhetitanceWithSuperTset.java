class Vehicle {
    ...
    public Vehicle (float rpm, float fuel, float pressure, String color) {  // 생성자
        this.rpm = rpm;
        this.fuel = fuel;
    ...
    @Override
    public String toString() {  // toString쓰면 객체의 정보 알수있음
        return "Vehicle{" +
                "rpm=" + rpm +
                ", fuel=" + fuel +
                ", pressure=" + pressure +
...
public class InhetitanceWithSuperTset {
    public static void main(String[] args) {
    Vehicle v = new Vehicle(200,1.2f, 1.0f, "Red");

        System.out.println(v);

        Airplane a = new Airplane(1000, 112.5f, 12.3f, "White", 77.3f, 0.02f, 33.9f);
