public class ArrayTest {
    public static void main(String[] args) {
        ...
        // 만일 회사에서 직원 1000명을 관리해야 한다 가정하면
        ...
        // 그러니 우리는 심신의 안정을 위해 배열을 사용해야 할 것이다.
        ...
        // 그러나 방 번호가 순차적으로 증가하기 때문에 for문이나 while문등 반복문과의 혼합구성에 있어 매우 탁월하다
...
// stack(지역변수)에 할당한다는 것은 지역변수로 처리함을 의미함
// 그렇기 때문에 나중에 매서드나 클래스를 학습한 이후 stack에 할당하면
// 해당 매서드혹은 클래스 내부에서만 해당 배열이 활성화됩니다
