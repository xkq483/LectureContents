...
public class SocketServerTest {
    ...
    public static void main(String[] args) {
        // 포트의 역할 : 서비스 신호
        // 결국 우리가 어떤 서비스에 접근하기 위해서는 무엇을 알아야 한다 ? 아이파와 포트
        ...
        try {
            ...
            while (true) {
                // acceot() 부분에서 서버는 Blicking(블록킹) 연산을 수행하고 있음
                ...
                // BufferedReadder() : 데이터가 많이 들어오거나 빈번하게 지속적으로 들어올 수 있어
