// 43번 문제 스캐너 + static 으로 풀어보기 ---------------------------------------------
// 직원 10명 + 초봉 2400 ~ 3500 + 연봉 인상률 1% ~ 20%
// 10 년후의 각 직원들의 연봉 + 연별로 평균 연봉값을 계산

import java.util.Scanner;

// <클래스 배열>
// 1. 직원 정보에는 이름과 자신의 페이가 기록됨
//    여기서 페이는 배열로 작성하여 연별 값을 얻을 수 있어야함
// 2. 초봉 설정은 2400 ~ 3500
...
public class Review0525 {
    ...
    // 클래스를 new하지 않고도 사용하기 위해 스캐너에 static을 붙인다
