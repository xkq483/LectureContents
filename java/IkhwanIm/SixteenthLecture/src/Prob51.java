...
class Market {
    ...
    private void doPayment () {
        myMoney = 10000000;
        ArrayList<Integer> userBuyListStockClone = (ArrayList<Integer>) userBuyListStock.clone();
        Object[] userBuyListStockArr = userBuyListStockClone.toArray();
        for(int i = 0 ; i < marketSellList.length; i++) {
         //   userBuyPrice = userBuyListStockArr[i]*marketSellListPrice[i];
        }
