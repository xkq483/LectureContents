public class Quiz23 {
    public static void main(String[] args) {
        ...
        for (int i = 1; i < 7; i++) {
            ...
            //
            //   22번대로 하면 제가 생각하기에는 testBit값이 0 그대로 변하지를 않아서 중복체크가 안 되야 하는데 정상작동해서 왜 그런지 이해가 잘 안 됩니다.
            //   마찬가지로 quiz23도 testBit값이 변하질 않아 중복체크가 안 되어서 밖으로 빼 이미 나온 숫자를 testBit에 더해 중복체크를 했습니다.
            //   22번 예제와 차이가 무엇인지 궁금합니다.(제가 testbit 중복체크 방식을 제대로 이해하지 못한 거 같습니다)
