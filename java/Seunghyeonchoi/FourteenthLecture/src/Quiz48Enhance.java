...
class Roulette {
    ...
    public void nameSubstitution (String[] names) {   //// 숫자 -> 이름 변환 코드
        for (int i = 0; i < 3; i++) {
            System.out.printf("%d번째 당첨자 : %s\n", i + 1 , names[success[i]]);
        }
    }
...
public class Quiz48Enhance {
    public static void main(String[] args) {
        ////48번 큰 흐름 작성(숙제 중복 제거[가능하면] + 코드 보완)
        ...
        r.checkSuccess();
        r.printSuccessArr();
        r.nameSubstitution(names);////이름 변환
