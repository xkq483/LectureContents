...
public class ChangeQuestionAnswerName {
    public static void main(String[] args) throws InterruptedException {
        ...
        for (int i = 1 ; i != 2; ) {
            ...
            int mydice1 = (int) (Math.random()*7);
            int mydice2 = (int) (Math.random()*7);
            // 오타 주의!
            ...
            int pcdice1 = (int) (Math.random()*7);
            int pcdice2 = (int) (Math.random()*7);
