...
public class SwitchTest {
    public static void main(String[] args) {
        ...
        while (isTrue){
            ...
            switch (num) {
                ...
                default:
                    ...
                    // 우리가 예상치 못한 입력이 존재할 수 있음 (switch안에 case x로 처리를 안한것)
        ...
        System.out.println("문자열 switch처리가 되나요? 일단 해봅시다 : ");
        Scanner scan1 = new Scanner(System.in);

        String str = scan1.nextLine();
        // String 선언하고 nextLine() 사용!!
        ...
        switch (str) {
            ...
            case "ho" :
                ...
                break;
            default:
                System.out.println("hi, ho 둘중 하나만 입력해야 나온다!");
                break;
        }
        }
    }
