...
public class inputtest {
    public static void main(String[] args) {
        ...
        //   그러므로 마찬가지로 클래스를 학습할 떄 같이 배웁니다.

        //3. 소괄호 내부에 있는 System.in 은 또 뭐지?
        //   System.in의 경우엔 시스텝 입력이라는 의미로 사용됩니다
        //   키보드나 마우스 같은 입력 장치라고 생각하면 되는데 키보드라고 생각하면 됩니다.
        //   결혼 scan 이라는 변수를 통해 키보드에 대한 제어를 수행하겠습니다
        Scanner scan = new Scanner(System.in);
        // println()의 경우엔 엔터키(줄바꿈)이 적용됨
        // prin()는 엔터기가 적용되지 않음
     System.out.print("아무 숫자나 입력해보세요: "); int num = scan.nextInt();
     //
    }
}
