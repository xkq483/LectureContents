public class NonDuplicateQuestionAnswer { // 주석부분 작성덜했음
    public static void main(String[] args) {
        ...
        for (int i = 0; i < 10; i++) {
            ...
            // 우선 randNum은 랜덤하게 나오곘지만 설명을 위해 특정 상황을 가정한다
            ...
            //------------------------------------------
            //                    00 0000 0000 그러므로 결과는 0이 되어 while Loop 진입x
            // testBit          = 00 0000 0000
            // BIN << randNum   = 00 0000 0100 OR
            //------------------------------------------
            // testBit          = 00 0000 0100
            //중복이 발생하지 않음을 확인한 이후 testBit에 값을 설정함
            // 여기에 값을 설정함으로써 이후 값은 위치에 AND가 발생하면 중복이라는 것을 판정할수 있음
