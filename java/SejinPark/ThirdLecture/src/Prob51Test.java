...
class Market {
    ...
    private ArrayList<Integer> marketSellListPriceStock;
    ...
    private void doPayment () {
        ...
        do{
            for(int i=0; i<userBuyList.size(); i++){
                sum += userBuyListStock.get(i)*marketSellListPrice[i];
                //계속 선풍기 가격만 나옵니다.
                //marketSellListPrice를 어떻게 바꾸면 좋을까요?
            }
            System.out.printf("가격은: %d",sum);
