    ...
    public static void main(String[] args) {
        ...
        if (num <= 0) {
            ...
            for (int i = 0; i < num - 2; i++) {
                //-2의 정체? 시작 시 퍼스트와 세컨드 값을 알고 했기 때문.
                //루프를 한 번만 돌아야 하니까. 무슨 말인지 이해 안갔음!
                //최준환씨 코드는 다른데, 이것도 참고해보기.

                res = first + second;
                first = second;
                second = res;
                // first second res
                //   1      1    2  첫번째 루프에서 퍼스트+_세컨드까지의 상태
                //   1      2    3  두번째 루프에서 퍼스트+_세컨드까지의 상태
                //   2      3    5  세번째 루프에서 퍼스트+_세컨드까지의 상태
            }
