public class Quiz25 {
    public static void main(String[] args) {
        ...
        for (int i = 1; i <= 100; i++) {
            if (i % 11 == 0 && i % 5 == 0 && i % 2 == 0) {  // 110의 배수 출력 -> 1~100 사이라 없음
                System.out.println("110의 배수 = " + i);
            } else if (i % 11 == 0 && i % 5 == 0) {         // 55의 배수 출력
                System.out.println("55의 배수 = " + i);
            } else if (i % 11 == 0 && i % 2 == 0) {         // 22의 배수 출력
                System.out.println("22의 배수 = " + i);
            } else if (i % 5 == 0 && i % 2 == 0) {          // 10의 배수 출력
                System.out.println("10의 배수 = " + i);
            } else if (i % 11 == 0) {
                System.out.println("11의 배수 = " + i);      // 11의 배수출력
                sum += i;
            } else if (i % 5 == 0) {
