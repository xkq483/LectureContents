...
public class inputTest {
    public static void main(String[] args) {
        ...
        // 3. 소괄호 내무에 있는 System.in 은 또 뭐지?
        //    system.in의 경우엔 시스템 입력이라는 의미로 사용됩니다.
        //    키보드나 마우스 같은 입력장치라고 생각하면 되는데 카보드라고 생각하면 됩니다.
        ...
        // ex) 시나리오 : 키보드에 숫자 35를 입력하고 엔터를 침
        // scan.nextInt()에서 키보드 입력 35를 받아서 int 형 35를 만듬
        // 그리고 변수 num에 변환된 int형 숫자 35를 저장한다.
        // Q : 키보드를 입력하는 35는 숫자 35가 아닌가요?
        // A : 네 아닙니다. - 실제로 보통 키보드에 대한 입력 처리는 문자 형태인 byte로 처리가 됩니다.
        //     좀 더 내부적으로 이야기를 하면키보드 입력에 대한 전기 신호를 해석합니다만 여기서 다룰 내용이 아닙니다.
