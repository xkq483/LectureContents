...
public class a_NetworkDiceGame {
    int myDice;
    int targetDice;
...
class GameResultThread extends a_NetworkDiceGame implements Runnable {
...
class GameStartProcess extends a_NetworkDiceGame {
    Thread sender;
    Thread receiver;
