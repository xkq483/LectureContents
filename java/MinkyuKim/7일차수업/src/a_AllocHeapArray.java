...
public class a_AllocHeapArray {
    public static void main(String[] args) {
        ...
        // Heap 공간에 int형 배열을 studentNum 개수만큼 만들겠습니다. 라는 의미와 같다.
        // studentArr는 Heap에 생성된 공간을 제어하게 된다.
        // [0], [1]. [2], .... [3] 등의 인덱스가 Heap에 있는 공간을 바라보게 된다는 뜻인데
