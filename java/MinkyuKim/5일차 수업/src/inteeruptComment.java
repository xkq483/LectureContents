...
// intrrupt : 인터럽트란?
// 사실 인터럽트란 용어는 하드웨어 개발자들이 주로 사용하는 단어다.
...
// 1. 몰컴을 하고 있었음. 펜타킬 찍음
// 2. 갑자기 안방의 문이 열렸음.
// ???? 어떻게 해야할까요 ????  ---> 빨리 모니터 끄고 여차하면 끄고 자는척 시전
// >> 문을 열어보시고 걸리면 이제 인생온라인 로그아웃
// >> 이게 아닐면 문을 열어보시고 잘못 들었나? 하고 화장실갔다가 다시 주무시러 가실것임
...
// 결국 Thread.sleep()이 가장 중요한 작업이므로
