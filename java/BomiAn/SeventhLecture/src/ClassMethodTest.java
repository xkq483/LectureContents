class Teacher {
    ...
    // 우선 제일 간단한 Getter, Setter부터 갑니다.
    // 마우스 커서를 아래다 갖다놓고 Alt + Insert 를 누른다 / 맥북의 경우 cmd + n
    // Getter & Setter -> 전부 선택하고 OK 하면 자동으로 Setter 와 Getter 가 만들어진다.
    // 만약 키보드 설정이 안맞는 경우 code -> Generate 로 같은 작업을 할 수 있다.
