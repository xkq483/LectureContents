public class ArrayTest {
    public static void main(String[] args) {
        ...
        // 일일이 int a, b, c, d, e, f, g, h, i, .......z까지  해 봐야 26개 밖에안됨
        // 만약 회사에서 1000명을 관리해야 한다 가정한다면
        // 이것을 일일이 변수로 선언한다면 죽을 것이다.
        // 당연히 배열을 만들어서 관리해야 할 것이다.

        int arr[] = {1, 2, 3, 4, 5};
        // int nu1 = 1, num2 = 2....num5 = 5;
        // 데이터가 많으면 많을수록 단일 변수 선언은 지옥을 체험할 것이다.
        // 당연히 배열을 만들어서 관리해야 할 것이다.
