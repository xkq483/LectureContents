...
class TestDice3 {
    ...
    void chekWinner () {
        switch (whoWin()) {
            case 1 :
                System.out.printf("폐관수련 입니다. %d (컴퓨터) vs %d (사용자)\n", comDice, userDice);
                break;
            case 2:
                System.out.printf("사용자가 이겼습니다. %d (컴퓨터) vs %d (사용자)\n", comDice, userDice);
                break;
            case 3 :
                System.out.printf("비겼으니 형은 면합니다. %d (컴퓨터) vs %d (사용자)\n", comDice, userDice);
                break;
        }
    }
    ...
    Boolean redoDiceGame() {
        System.out.print("게임을 계속 하시겠습니까? 예(1)/아니오(0)  ");
...
public class QuizTest35Enhance {
