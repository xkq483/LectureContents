    ...
    methods: {
       ...
       beforeUpdate() {
           ...
           if(this.characterStatus.selectJob != '모험가'){
                ...
                this.characterStatus.defaultAtk += 30
                this.characterStatus.atk += 30
                this.characterStatus.def += 10
                this.characterStatus.str *= 1.5
                this.characterStatus.increment *= 1.5
                this.characterStatus.dex *= 1.5
                this.characterStatus.def *= 1.5
                this.characterStatus.vit *= 1.5
                this.characterStatus.men *= 1.5
           }
