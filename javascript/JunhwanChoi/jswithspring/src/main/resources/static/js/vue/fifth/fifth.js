var app = new Vue ({
        ...
        suddenRaid () {
            for (var i = 0; i < this.monsters.length; i++) {
                this.monsters[i].hp =
                    ...
                    this.characterStatus.atk * 10 + this. characterStatus.intelligence * 1.5 +
    ...
    beforeUpdate() {
        ...
        if (this.characterStatus.selectJob === '도적'){
        ...
        for (; this.characterStatus.currentLevelBar >= this.characterStatus.totalLevelBar; ) {
            ...
            } else if (this.characterStatus.selectJob === '도적') {
                console.log('도적입니다.')
