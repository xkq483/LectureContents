var app = new Vue({
    ...
    data: {
        message: '우왕 뷰짱',
        initMsgTest: '양방향 연결이 뭔지 함 볼까!?',
        list: ['사과','바나나','딸기','수박','참외','망고'],
        show: false,
        num: 3,
        count: 0,
        increment: 0,
    ...
    methods: {
        ...
        buttonClickTest2: function(event)
        {
            alert('2번째테스트')
        },
        //작성형식
        //함수이름: function() {} ==> 중괄호에는 일반 매서드 작성과 동일
        //아래와 같이 함수로 구성해도됨
        inc_function: function() {
            this.count+=1
        },
          addMonster: function () {
                    // 샘플용 코드
