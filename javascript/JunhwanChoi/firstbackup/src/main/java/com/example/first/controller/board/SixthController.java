package com.example.first.controller.board;
...
public class SixthController {
    ...
    //한가지 차이가 있다면 나중애 파이썬과 연동할때
    // Spring Requester를 통해서
    // Spring 자체가 client가 되어 python Server에 요청을 넣어야함
    // 그 시점에서 Spring이 직접 Json을 처리할 필요가 있음
