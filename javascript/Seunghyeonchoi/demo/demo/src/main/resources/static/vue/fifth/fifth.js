var app = new Vue ({
    ...
    methods: {
        selectJob () {
            console.log('지금 this.characterStatus.selectJob은 : ' + this.characterStatus.selectJob + '이고 스킬 오픈하겠다' )
            this.finishSelectJob = false
            this.uniqueSkillView = true
        },
        uniqueSkillShow () {
            switch(this.characterStatus.selectJob) {
                case 'madWarrior':
                    ...
                    console.log('madWarrior 유니크스킬 버튼을 눌렀습니다.')
                    break
                case 'warrior':
                    for (var i = 0; i < this.monsters.length; i++) {
                        this.monsters[i].hp = 
                    ...
                    console.log('warrior 유니크스킬 버튼을 눌렀습니다.')
                break
                case 'magician':
                    for (var i = 0; i < this.monsters.length; i++) {
                        this.monsters[i].hp = 
                    ...
                    console.log('magician 유니크스킬 버튼을 눌렀습니다.')
                    break
                case 'thief':
                    for (var i = 0; i < this.monsters.length; i++) {
                        this.monsters[i].hp = 
                    ...
                    console.log('thief 유니크스킬 버튼을 눌렀습니다.')
                break
                case 'archer':
                    for (var i = 0; i < this.monsters.length; i++) {
                        this.monsters[i].hp = 
                    ...
                    console.log('archer 유니크스킬 버튼을 눌렀습니다.')
                    break
                case 'gunner':
                    for (var i = 0; i < this.monsters.length; i++) {
                        this.monsters[i].hp = 
                    ...
                    console.log('gunner 유니크스킬 버튼을 눌렀습니다.')
                break
                case 'boxer':
                    for (var i = 0; i < this.monsters.length; i++) {
                        this.monsters[i].hp = 
                    ...
                    console.log('cboxerase7 유니크스킬 버튼을 눌렀습니다.')
                    break
                default:
                    console.log('뭔가 오류가 생김.')
                    console.log('지금 selectJob 값은 : ' + this.characterStatus.selectJob)
                    console.log('지금 uniqueSkill 값은 : ' + this.uniqueSkill)
                break                        
            }
    ...
    beforeUpdate() {
        ...
        for (; this.characterStatus.currentLevelBar >= this.characterStatus.totalLevelBar; ) {
            ...
            else if (this.characterStatus.selectJob === 'madWarrior') {
                console.log( + this.selectJob +'입니다.')
            ...
            else if (this.characterStatus.selectJob === 'boxer') {
                console.log('권사입니다.')
