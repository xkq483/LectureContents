var app = new Vue ({
    ...
    methods: {
        ...
        stormStep () {
            for (var i = 0; i < this.monsters.length; i++) {
            this.monsters[i].hp = parseInt(this.monsters[i].hp - this.characterStatus.atk * 4)
    ...
    thiefAtk(index) {
        this.monsters[index].hp -= this.characterStatus.atk * 30 +
                                    ...
                                    this.characterStatus.dex * 35 +
                                    this.characterStatus.intelligence * 1.0
    }
    },
    beforeCreate() {
    ...
    beforeUpdate() {
        ...
        for (; this.characterStatus.currentLevelBar >= this.characterStatus.totalLevelBar; ) {
            ...
            if (this.characterStatus.selectJob === '모험가') {
                ...
                this.characterStatus.defaultAtk *= 1.1
                this.characterStatus.atk = this.characterStatus.defaultAtk + tmpSub
                this.characterStatus.def += 1.5
                this.characterStatus.str *= 2
                this.characterStatus.intelligence *= 1.05
                this.characterStatus.dex *= 1.5
