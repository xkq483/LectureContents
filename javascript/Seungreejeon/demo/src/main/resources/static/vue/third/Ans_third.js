var app = new Vue ({
    ...
    beforeUpdate() {
        ...
        if ((this.characterStatus.selectJob === 'madWarrior') && this.state === 0) {
            this.characterStatus.atk += 5000
            this.state = 1
        }

        if ((this.characterStatus.selectJob === 'warrior') && this.state === 0) {
            this.characterStatus.atk += 444
            this.state = 1
        }

        if ((this.characterStatus.selectJob === 'magician') && this.state === 0) {
            this.characterStatus.atk += 34234
            this.state = 1
        }

        if ((this.characterStatus.selectJob === 'thief') && this.state === 0) {
            this.characterStatus.atk += 999999
            this.state = 1
        }
