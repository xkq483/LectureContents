var app = new Vue ({
    ...
    methods: {
        ...
        warrior2chaSkill () {
            for (var i = 0; i < this.monsters.length; i++) {
                this.monsters[i].hp = 
                    parseInt(this.monsters[i].hp - (this.characterStatus.atk * 3.5 +this.characterStatus.hp * 0.2 +
                       this.characterStatus.dex*3.5+this.characterStatus.vit*3.5 + this.characterStatus.str *3.5))
            }
        },
        Magician2chaSkill () {
            for (var i = 0; i < this.monsters.length; i++) {
                this.monsters[i].hp = 
                    parseInt(this.monsters[i].hp - (this.characterStatus.atk * 3.5 +this.characterStatus.intelligence *500+this.characterStatus.hp * 0.1
                        +this.characterStatus.dex*3.5+this.characterStatus.vit*3.5 + this.characterStatus.str *3.5))
            }
        },
        thief2chaSkill () {
            for (var i = 0; i < this.monsters.length; i++) {
                this.monsters[i].hp = 
                    parseInt(this.monsters[i].hp - (this.characterStatus.atk * 3.5 +this.characterStatus.intelligence *10 +this.characterStatus.hp * 0.1 
                        +this.characterStatus.dex*3.5+this.characterStatus.vit*3.5 + this.characterStatus.str *3.5))
            }
        },
        pirate2chaSkill () {
        ...
        knight2chaSkill () {
            for (var i = 0; i < this.monsters.length; i++) {
                this.monsters[i].hp = 
                    parseInt(this.monsters[i].hp - (this.characterStatus.atk * 3.5 +this.characterStatus.intelligence *10+this.characterStatus.hp * 0.15
                        +this.characterStatus.dex*3.5+this.characterStatus.vit*3.5 + this.characterStatus.str *3.5))
            }
        },
        army2chaSkill() {
       ...
       if((this.characterStatus.level >=20) &&  (this.characterStatus.selectJob =='모험가')){
        ...
        for (; this.characterStatus.currentLevelBar >= this.characterStatus.totalLevelBar; ) {
            ...
            this.characterStatus.intelligence +=0.5}
                ...
                this.characterStatus.defaultAtk += 550
                this.characterStatus.atk += 550
                this.characterStatus.def += 500
                ...
                this.characterStatus.defaultAtk +=600
                this.characterStatus.atk += 600
                ...
                this.characterStatus.dex += 900
                this.characterStatus.defaultAtk += 900
                this.characterStatus.atk += 1500
                this.characterStatus.def += 120
                ...
                this.characterStatus.hp *= 2.3
                this.characterStatus.dex += 1200
                this.characterStatus.defaultAtk += 700
                this.characterStatus.atk += 700
                this.characterStatus.def += 20
            ...
            if(this.characterStatus.selectJob =='Warrior'){
                this.ifyouwarrior = true

            }
            else if(this.characterStatus.selectJob =='Magician'){
                this.ifyouMagician = true

            }
           else if(this.characterStatus.selectJob =='thief'){
                this.ifyouthief = true

            }
          else if(this.characterStatus.selectJob =='archer'){
                this.ifyouarcher = true

            }
           else if(this.characterStatus.selectJob =='pirate'){
                this.ifyoupirate = true

            }
           else if(this.characterStatus.selectJob =='knight'){
                this.ifyouknight = true
