...
@Slf4j
@Controller
public class EleventhJavaScriptController {
    ...
    @GetMapping("/calcBankMoneyTest")
    public String getCalcBankMoneyTest() {
        log.info("getCalcBankMoneyTest()");

        return "/javascript/eleventh/calcBankMoneyTest";
    }
