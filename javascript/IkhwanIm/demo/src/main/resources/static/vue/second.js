var app = new Vue ({
    ...
    data: {
        ...
        monsterBook: [
            ...
            { id: 2, name: '고블린', hp: 50},
            { id: 3, name: '카오스 드래곤', hp: 9999999 },
            { id: 4, name: '키메라', hp: 500},
            { id: 5, name: '공룡', hp: 250},
            { id: 6, name: '두루미', hp: 1000},
            { id: 7, name: '판다', hp: 1200},
            { id: 8, name: '고릴라', hp: 2500},
            { id: 9, name: '자바', hp: 100},
            { id: 10, name: '자바스크립트', hp: 80}
        ]
    },
    methods: {
        ...
        addMonster: function () {
            // 샘플용 코드
            var arr = [1, 2, 3, 4];
            // reduce ( function (유지되는 값, 계속 비교하거나 연산 대상이 되는 값))
        ...
        addRandomMonster: function () {
            ...
            this.monsters.push({
                id: max + 1,
                name: this.monsterBook[j-1].name,
                hp: this.monsterBook[j-1].hp
            })
