var app = new Vue ({
    ...
    data: {
        ...
        monsterName: '',
        monsters: [
            {createNumber:0, id: 1, name: '슬라임', hp: 30 },
            {createNumber:0, id: 2, name: '고블린', hp: 50 },
            {createNumber:0, id: 3, name: '투명 드래곤', hp: 99999999 },
            {createNumber:0, id: 4, name: '크림슨 드래곤', hp: 49 },
            {createNumber:0, id: 5, name: '카오스 드래곤', hp: 32 },
            {createNumber:0, id: 6, name: '화이트드래곤', hp: 19 },
            {createNumber:0, id: 7, name: '레드 드래곤', hp: 21 },
            {createNumber:0, id: 8, name: '오렌지 드래곤', hp: 11 },
            {createNumber:0, id: 9, name: '블랙 드래곤', hp: 13 },
            {createNumber:0, id:10, name: '퍼플 드래곤', hp: 58 }
    ...
    methods: {
        ...
        addRandomMonster:function(){
            var randIndex =  Math.floor(Math.random() *10) + 1

            this.createdMonster.push(
                this.monsters[randIndex]
            )



            alert(this.monsters[randIndex].value)
