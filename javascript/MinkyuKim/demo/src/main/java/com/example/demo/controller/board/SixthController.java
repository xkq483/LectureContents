...
public class SixthController {
    ...
    public String getJsonKeyValueTest () {
        ...
        // 향후 Vue에서 보내는 데이터도 전부 이 json 형태로 날아옴.(따라서 json형식을 해석할수 있어야함.)
    ...
    public String getJsonMultiObjectTest () {
        ...
        //++ movie에 대한 키값 title 벨류값 hihi, 키값 draft, star 벨류값 false, 5가 포함됨.
        //++ movie1에 대한 title draft star
        //++ json은 HashMap과 같음
        //++ String Boolean Int등 데이터타입에 맞추어 키값을 작성하면됨
